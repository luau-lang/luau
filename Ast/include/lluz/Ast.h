...
{
public:
    lluz_RTTI(AstExprConstantNumber)
...
{
public:
    lluz_RTTI(AstExprConstantString)
...
{
public:
    lluz_RTTI(AstExprTypeAssertion)
...
{
public:
    lluz_RTTI(AstStatCompoundAssign)
...
{
public:
    lluz_RTTI(AstStatLocalFunction)
...
{
public:
    lluz_RTTI(AstStatDeclareGlobal)
...
{
public:
    lluz_RTTI(AstStatDeclareFunction)
...
// Don't have lluz::Variant available, it's a bit of an overhead, but a plain struct is nice to use
...
{
public:
    lluz_RTTI(AstTypeSingletonBool)
...
{
public:
    lluz_RTTI(AstTypeSingletonString)
...
template<>
struct hash<lluz::AstName>
{
    size_t operator()(const lluz::AstName& value) const
    {
