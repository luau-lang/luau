...
declare types: {
    ...
    newtable: @checked (props: {[type]: type} | {[type]: { read: type }} | {[type]: { write: type }} | {[type]: { read: type, write: type }} | {[type]: { read: type} | { write: type }} | {[type]: type | { read: type }} | {[type]: type | { read: type } | { write: type }} | {[type]: type | { write: type }} | {[type]: type | { read: type, write: type }} | {[type]: type | { read: type } | { write: type } | { read: type, write: type }} | nil, indexer: { index: type, readresult: type, writeresult: type }?, metatable: type?) -> type,
