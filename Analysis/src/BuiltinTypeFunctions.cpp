...
LUAU_FASTFLAGVARIABLE(LuauFixSingletonReduceGenerics)
...
BuiltinTypeFunctions::BuiltinTypeFunctions()
    ...
    , singletonFunc{"singleton", singletonTypeFunction, /*canReduceGenerics*/ FFlag::LuauFixSingletonReduceGenerics}
