...
LUAU_FASTFLAGVARIABLE(LuauFixPreserveSolvedTypeFunctionState)
    ...
    TypeId clean(TypeId ty) override
    {
        ...
        if (isNewSolver())
        {
            ...
            else if (auto tfit = get<TypeFunctionInstanceType>(ty))
            {
                ...
                else if (FFlag::LuauFixPreserveSolvedTypeFunctionState && tfit->state == TypeFunctionInstanceState::Solved)
                {
