...
// Luau: `types.newtable(props: {[type]: type} | {[type]: type | { read: type?, write: type? }}?, indexer: {index: type, readresult: type,
// writeresult: type}?, metatable: type?) -> type` Returns the type instance representing table
